...
## Range Maps 
  \begin{center}
\includegraphics[width=8in]{..//docs/acerpens.pdf}

\includegraphics[width=8in]{..//docs/betupapy.pdf}

\includegraphics[width=8in]{..//docs/cornalte.pdf}

\includegraphics[width=8in]{..//docs/fagugran.pdf}

\includegraphics[width=8in]{..//docs/hamavirg.pdf}

\includegraphics[width=8in]{..//docs/sorbamer.pdf}
\end{center}
...
Another factor that is crucial to an understanding of the relationship between a species, its competitors, and its environment is its growth stage. Indeed, growth stage has been shown to make a marked difference in how a species responds to a warming environment and competitive interactions (Zhu et. al 2012; Ettinger and HillesRisLambers 2013). In modeling future species distributions, taking into account growth stages for more long-lived species such as the deciduous trees examined in my study will provide a much clearer and more accurate idea of species’ responses to climate change.
...
Note: these are the stipulations for the Discussion — The discussion section should first of all summarize and analyze the results that you have presented. Also recapitulate your overall argument(s) presented in the Introduction as well as strengths and weaknesses, and address the theoretical issues that were used in approaching and analyzing the problem. You should also explain how you may have modified your view of the issues in the course of conducting the analysis. If your experiments did not produce significant or meaningful results, explain here your thoughts on why this might have occurred, and suggest how things could be done differently. Convince the reader that you have fully thought through and understand the implications of your work, no matter how individual experiments may have turned out. 

Question: where should I integrate how things could be done differently?

...
#ACEPEN
abline(0.04023972, -0.009001288, col="#1B9E77", lwd=2)

#BETPAP
abline(-0.24810866,  0.055499823, col="#D95F02", lwd=2)

#CORALT
abline(0.06201265, -0.013871708, col="#7570B3", lwd=2)

#FAGGRA
abline(0.04033458, -0.009022507, col="#E7298A", lwd=2)

#HAMVIR
abline(0.05346396, -0.011959439, col="#66A61E", lwd=2)

#SORAME
abline(0.05205775, -0.011644882, col="#E6AB02", lwd=2)
...
\begin{table}[h!]
  ...
  \begin{tabular}{cccc}
    ...
    $Cornus$ $alternifola$ & 7.62 x $10^{-2}$\\
...
My results suggest that the effect of biotic and abiotic factors on limiting trees at their range limits vary across species. There is some evidence that interspecific competition limits a species more at its southern range limit, where climate is not as strong of a limiting factor (**AHL: CITE FIGURE HERE: BA vs Latitude for BETPAP**). Similarly, I observed a small negative trend overall in competitiveness index as a species moves  away from its climatic centroid (**AHL CITE FIGURE HERE**). This suggests that there is a complex relationship between abiotic and biotic factors. Both factors are thus important in predicting migration rates of species in a warming world. *AHL: Can I say this: Warming at a species’ northern range edge could ameliorate the limiting effect of biotic factors.*

	A. Observations (possible include MDS?)
	B. Observations taken together mean… (restate summary statement)
II. H1: Species become less competitive at their range limits (subsection title: Incorporating biotic and abiotic factors in competitiveness. Review result: no distinct pattern across all deciduous trees. At their northern limits, other factors could be playing a larger part. 
	A. Fig. 1…how does this finding fit in with the literature?
	-  species are more limited by competition at their southern edges  (AHL citation?)
	-  range shifts will probably lag the velocity of climate change **Loarie et al 2009**
	-  biotic interactions create lags in climate tracking (Fisichelli et. al 2012) models replicate this (Svenning et. al 2014)
	- environment as more important
	
	B. Fig. 2…how does this finding fit in with the literature?
III. H2: Trees exhibit altered suites of functional traits at their range extremes (subsection title: Functional traits of species possibly tied to local factors
	A. Fig. 1…how does this finding fit in with the literature?
	B. Fig. 2…how does this finding fit in with the literature?
IV: Conclusion/Areas of further research
	A. Could a change in environment lead to more of an effect seen on competition?
	B. Looking at competition using different index
	...
	just a snapshot in something that should be observed over years to really understand if a shift is possible. Growth/establishment of plants is better indicator of survival

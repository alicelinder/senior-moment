...
# Discussion    
<!-- I like your opening section! Just need to tighten it up -->

Ecologists have long understood that range limits are caused by complex dynamics between biotic and abiotic factors. These dynamics are especially important to understand in light of climate change. 
<!-- The next two sentences are too similar, combine into one sentence or make two unique points. Also, do you want to mention competition in this opening, explanatory paragraph?.-->
A warming world and shift in abiotic factors necessitates research into the limiting effect of both abiotic and biotic interactions at range limits. As a species’ climatic envelope migrates north, looking at the limiting power of biotic and abiotic factors can provide insight into the future survival of that species. 
...
<!-- Add a short paragraph introducing traits (just the way your first paragraph introduces abiotic and biotic). -->
...
I found no strong support for my hypothesis that species would decrease in competitiveness as they approached their latitudinal and/or climatic range limits. The overall trend in competitiveness across latitudes was positive, indicating a slight increase in dominance as a species goes north. This lack of clear pattern probably indicates that latitudinal range limits are caused by a complex interplay of biotic and abiotic factors that is not fully accounted for in simply examining a species’ competitiveness. This suggests that competition is not predicted by its position in its latitudinal range (**H1, A2)**. <!-- Need a little more to this paragraph (or perhaps could be two paragraphs?). What does it mean that "that competition is not predicted by its position in its latitudinal range" and how does it relate to the immediately preceeding sentence? -->
  
The overall lack of a significant relationship competitiveness and position in range, combined with different relationships for certain species, indicate that there are other factors playing a part in determining a species' range limits. These other factors probably prevent a clear pattern from emerging in my data. 
<!-- Below I think you need a setup sentence where you just say -- size class may matter, then break down why ... right now you're trying to do the work of 2-3 sentences in one sentence and it's very hard on the reader. -->
It is possible that the species of trees, such as *H. virginiana*, *A. pensylvanicum*, and *S. americana*, that are mid-sized and never reach the same level of competitiveness in basal area as *B. papyrifera*, for example, are more susceptible to biotic factors as they near their latitudinal range limits. This could be due to biotic factors not examined, such as percentage cover in the canopy, which are widely recognized as constraining plant development over time due to possible loss of energy from sunlight (Biging & Dobbertin 1995, Contreras et. al 2011). To account for this, one could utilize a different competition index in a similar study on latitudinal and climatic ranges. 
<!-- But are distance-dependent indices going to help if the species are just in totally different size classes? I think you either need to make this connection clear or make two separate points (1. Hey readers, maybe you should focus on species in one size class becuase they probably compete and 2. maybe other metrics would be better ... and why. Your stuff below is really nice! I just didn't see how it would help the size class issue. Also, you should link both these topics under a general theme or topic sentence related to "competition is hard to measure.") -->
More accurate competition indices are distance-dependent (whereas summing up the surrounding basal area of larger competitors than the focal individual is a distance-indepedent index). The best distance-dependent competition index is the sum of the horizontal angles multiplied by the ratios of the DBHs of the neighbor and the cored individuals (outlined in Rouvinen & Kuuluvainenas 1997 and as tested in Contreras et. al 2011). The downside of this method (and of distance-dependent competition indices in general) is that they require much more time to collect data. This is a major limiting factor in latitudinal studies, since so many resources are required to collect data in the field across such a large area. Additionally, studies have observed that the stronger limiting factors at a species' southern range limit are interspecific competition, while environmental factors limit species at their northern limits (Brown et. al 1996, Nakawatase & Peterson 2006). Due to the limited data I recorded of species with southern range limits close to the four sites, my study was lacking in this respect.
  
It is possible that community composition and local adaptation matter more. <!-- matter more than? Simple indices of competition?  -->
In this case, local community composition could be more predictive of a tree’s success. 
<!-- This next sentence for me does not connect to the one above ... help make the connection for readers! -->
<!--  Also be careful in assigning trees 'abilities.' -->
This is a positive outlook in terms of the possibility of a tree species’ potential to migrate north to account for population loss on its southern range edge, though this is not supported by current literature that suggests range shifts will probably lag the velocity of climate change (Loarie et. al 2009). 
<!-- Flip the order of your sentence below: you tended to focus on northern edges, but it is possible that a species ... -->
It is also possible that a species is more limited by competition at its southern edge, and thus my results would not reflect this as they are heavily reliant on species that lie closer to their northern range limits across our sites. Biotic interactions have been theorized as the stronger limiting factor at southern range edges. Additionally, ecological models predict that biotic interactions will create lags in climate tracking (Svenning et. al 2014). This has also been supported by experiments on the ground (Fisichelli et. al 2012). <!-- But what about the two of your species near their southern range limit? What do your results say relating to what you just discussed here? -->
  
<!-- Define sweet spot or re-word (I recommend re-word). -->  
I saw a similarly unclear pattern in competitiveness across species’ climatic envelopes. The only species to exhibit a decrease in competitiveness was *B. papyrifera*, suggesting that environment may be more of a limiting factor in its establishment than the other species examined. 
<!--The above and below don't fully connect for me, either make the connection clear to the reader or divide into two paragraphs. How can you find an unclear pattern then find a clear pattern? You must be discussing two different things but that's not clear to me as a reader.  -->
...
<!--Can you also cite a figure here below?  Also, is 'species’ relative functional richness' the same as 'how much of a community’s functional richness was occupied by each focal species'? If so you should add (species’ relative functional richness) above. -->
<!-- Is the sweet spot a climatic centroid?  -->
Conversely, across a climatic range there is overall a decrease in species’ relative functional richness. This suggests that environment, more than latitude, is a determining factor in the functional traits exhibited by a species. As a species moves farther away from its climatic “sweet spot,” its functional traits become more similar and show less variability relative to the functional richness of its community. In a study conducted by Guittar et. al (2016), only certain functional traits showed a reliable pattern across climatic gradients (including SLA, as examined in this study), but fewer traits were consistently predictive of changes in species abundances in warmed turf used in the study. <!-- This last sentence is written so that I wonder about your traits, one by one -- you might adjust the sentence so the reader doesn't start wondering about this. You could just say, Other studies examining SLA (Guittar et. al, 2016) have found similar results to mine. -->

  
This result confirms my hypothesis that trees moving away from their climatic range interior exhibit altered suites of functional traits from trees in their range interior, and specifically *A1*. 
<!-- Insert A1 written out in parentheses above after A1. Also the below sentence is a bit confusing -- what does 'such' in such suites mean and what does 'that' in that particular environment mean? -->
This suggests that such suites of traits are successful in that particular limiting environment (Burns and Straus 2012). However, functional trait similarity was not linked to a tree’s relative size (i.e. competitiveness index) within a plot.
<!-- Below sounds really cool, but I don't quite get it -- try to break it down more for readers (like me).  -->
This could suggest that abiotic factors play more of a part in the phenotypes observed in a species, though this is not supported by the literature (Burns and Straus 2012; Kunstler et. al 2015). In a study by Funk and Wolf (2016), certain suites of functional traits in grasses were a better predictor of competitive outcome than phylogenetic relatedness.

<!-- Need to reintroduce readers to convex hull, for example -- say this was another method to measure X and be clear if you are talking about across sites, latitudes or climatic sweet spots. If you are talking about convex hull stuff above then make that clear (I wasn't sure at all). If, alternatively, convex hulls are an additional way to look at trait variability so be sure to say how this compares with your findings from your other methods. -->
...
In predicting the future distributions of species in light of climate change, much is still unclear about the effect of biotic and abiotic variables. 
<!-- I think you could add something here like: above I discusses how size classes, lifestage and how competitive indices are calculated can impact results; another critical factor is whether the communities I measured were at equilibria ... or something. Or somehow add a better transition.  -->
...
<!-- For me it feels better to touch on this more in your section way above, then briefly touch on all those factors again here at the start of the new section. But up to you! If you do my plan, you might open this section with a short paragraph that effectively say: I touched on all this above, here's what it means for future studies ... then your section BETPAP could be the second paragraph.  -->

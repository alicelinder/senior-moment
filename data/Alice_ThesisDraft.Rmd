...
The strength of competition index - latitude relationships differed by species, with no clear pattern across all six species. There was little to no correlation between increasing latitude (approaching northern edges) and the competitive index of the focal trees. 
...
\begin{table}[h!]
  \centering
  \caption{Linear mixed-effects coefficients for Latitude}
  \smallskip
  \label{tab:table2}
  \begin{tabular}{cc}
    \toprule
    Species & Coefficient\\
    \midrule
    Acer pensylvanicum & -0.184\\
    Betula papyrifera & -0.1407\\
    Corylus alternifolia & -0.068\\
    Faggus grandifolia & 0.117\\
    Hamamelis virginiana & -2.049\\
    Sorbus americana & 0.250\\
    \bottomrule
  \end{tabular}
\end{table} 
